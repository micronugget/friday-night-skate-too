...
(function (Drupal, once) {
  ...
  function renderVideo(src, videoId, poster, posterFragment) {
    ...
    var onPlayClick = function onModalFacadeActivate(e) {
      ...
      var behavior = Drupal.behaviors.videojsMediablockPlayerInit;
      ...
      // same gesture.
      var videoEl = facade.querySelector('.videojs-lazy-target');
      if (videoEl) {
        videoEl.setAttribute('preload', 'auto');
        var nativePlay = videoEl.play();
      ...
      if (videoEl) {
        try {
          var playerInstance = window.videojs(videoEl);
