...
fridaynightskate theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of fridaynightskate theme and run the following commands:
`nvm use`
...
`drush en fridaynightskate -y`
`drush config-set system.theme default fridaynightskate -y`
